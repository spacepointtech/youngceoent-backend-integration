  ...
  <div>
    ...
    <h1 className="text-4xl font-bold text-white mb-8">Audience</h1>
          ...
          <div className="flex justify-start items-center mb-8 relative">
            ...
            <Link href="/dashboard/audience/segements" className="relative text-white font-bold mx-4 after:content-[''] after:absolute after:left-0 after:bottom-[-2px] after:h-[2px] after:bg-white after:w-[100%]">
              Segments
            </Link>
        ...
        <section className="bg-[#1A1A1A] p-6 rounded-lg shadow-lg w-[75%] mb-8 relative min-h-[500px]"> {/* Adjust the height */}
</section>
